...
public class Lebensmittel_am_Stück extends Lebensmittel{
	
	// Zum Verständnis: keine Fertiggerichte, sondern Wurst oder Käse am Stück (ebenfalls kein Aufschnitt)
	...
	public Lebensmittel_am_Stück(String name, Calendar mhd, String typ, double menge){
		super(name, mhd, typ);
		this.menge = menge;
	}
